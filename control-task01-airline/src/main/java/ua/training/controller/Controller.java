    ...
    private void getTotalListOfAircrafts() {
        ...
        for (Aircraft aircraft : aircrafts) {
            ...
            if (aircraft instanceof FreighterAircraft) {
                FreighterAircraft freighterAircraft = (FreighterAircraft) aircraft;
                ...
                specialCharacteristics = view.concatenateStrings(view.getBundleString(TextConstant.CARGO_COMPARTMENT_IN_CUBIC_METRES),
                        TextConstant.COLON_SING, String.valueOf(freighterAircraft.getCargoCompartmentInCubicMetres()), TextConstant.COMMA_SING, TextConstant.SPACE_SING,
                        view.getBundleString(TextConstant.SEATING_CAPACITY),
                        TextConstant.COLON_SING, String.valueOf(freighterAircraft.getSeatingCapacity()));
                ...
                specialCharacteristics = view.concatenateStrings(view.getBundleString(TextConstant.SEATING_CAPACITY),
                        ...
                        TextConstant.COLON_SING, TextConstant.SPACE_SING, String.valueOf(passengerAircraft.getSeatsByClass().get(PassengerClass.BUSINESS)),
                        TextConstant.COMMA_SING, TextConstant.SPACE_SING,
                        (view.getBundleString(TextConstant.ECONOMY_CLASS)),
                        TextConstant.COLON_SING, TextConstant.SPACE_SING, String.valueOf(passengerAircraft.getSeatsByClass().get(PassengerClass.ECONOMY)));
            }
